...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/tld-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14042&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tld-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tld` can be installed with:

```
conda install tld
```

It is possible to list all of the versions of `tld` available on your platform with:
